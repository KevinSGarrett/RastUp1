...
def main() -> None:
    ...
    for i in range(1, max_loops + 1):
        ...
        try:
            ...
            no_work = "No unblocked todo items found." in txt
            ...
            if no_work:
                ...
                if "No unblocked todo items found." in txt2:
                    print("[autopilot] Still no unblocked items after sweep; "
                          "stopping autopilot loop.")
                    break
