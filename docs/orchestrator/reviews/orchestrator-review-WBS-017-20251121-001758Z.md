...
- Assistant‑manager: **<orchestrator.providers.openai_provider.OpenAIProvider object at 0x7d4af3ce4a70>/gpt-5** (? ms)
- Primary‑decider: **<orchestrator.providers.anthropic_provider.AnthropicProvider object at 0x7d4af3d60320>/claude-3-5-sonnet** (? ms)
