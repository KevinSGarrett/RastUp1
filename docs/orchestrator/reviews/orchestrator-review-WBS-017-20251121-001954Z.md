...
- Assistant‑manager: **<orchestrator.providers.openai_provider.OpenAIProvider object at 0x7b18c0792bd0>/gpt-5** (? ms)
- Primary‑decider: **<orchestrator.providers.anthropic_provider.AnthropicProvider object at 0x7b18c0550ad0>/claude-3-5-sonnet** (? ms)
