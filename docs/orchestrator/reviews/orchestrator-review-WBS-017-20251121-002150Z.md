...
- Assistant‑manager: **<orchestrator.providers.openai_provider.OpenAIProvider object at 0x76f53bd4caa0>/gpt-5** (? ms)
- Primary‑decider: **<orchestrator.providers.anthropic_provider.AnthropicProvider object at 0x76f53b9d4230>/claude-3-5-sonnet** (? ms)
