...
- Assistant‑manager: **<orchestrator.providers.openai_provider.OpenAIProvider object at 0x70661c1d05c0>/gpt-5** (? ms)
- Primary‑decider: **<orchestrator.providers.anthropic_provider.AnthropicProvider object at 0x70661c37e300>/claude-3-5-sonnet** (? ms)
