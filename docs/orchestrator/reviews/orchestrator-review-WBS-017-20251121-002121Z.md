...
- Assistant‑manager: **<orchestrator.providers.openai_provider.OpenAIProvider object at 0x7032ef178a70>/gpt-5** (? ms)
- Primary‑decider: **<orchestrator.providers.anthropic_provider.AnthropicProvider object at 0x7032ef13ecf0>/claude-3-5-sonnet** (? ms)
