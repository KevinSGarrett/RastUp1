<!-- id: NT-0380 | source: ProjectPlans\Combined_Master_PLAIN_Non_Tech_001.docx | range: 1368000-1372000 -->

o checklist is \'done\' unless Support can resolve
...
synthetic bookings. We test under simulated load, outage, and edge cases
(ACH returns, 3DS failures, moderation queue spikes).\
• Holdouts & Experiments: Promotions, ranking, and any economic nudg