<!-- id: NT-0365 | source: ProjectPlans\Combined_Master_PLAIN_Non_Tech_001.docx | range: 1314000-1318000 -->

 staging with seeded data and
...
Implementation Notes:\
• Flags & City Gates: Every user‑visible change ships behind a flag with
a documented blast radius, an owner, and a rollback plan. 