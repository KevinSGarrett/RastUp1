...
- Project panel tabs expose snapshot JSON for `brief`, `moodboard`, `files`, `docs`, and `expenses` while the `actions` tab renders curated presenters; remaining tabs will graduate to design-system components in upcoming runs.
